...
function ImagemProduto({
  ...
  const [estado, setEstado] =
    useState<"carregando" | "pronta" | "erro">("carregando");

  if (!src || estado === "erro") {
    return (
      <p
        className="px-5 text-center text-sm leading-6 text-slate-500"
        role="status"
      >
        {src
          ? "Não foi possível carregar a imagem. Confira o endereço informado."
          : "Informe a URL da imagem para visualizar o produto."}
      </p>
    );
  }
  ...
  return (
    <>
      ...
      <img
        src={src}
        alt={nome || "Pré-visualização do produto"}
...
export default function AdminProdutosPage() {
  ...
  const [formularioSalvo, setFormularioSalvo] =
    useState<Formulario>(formularioInicial);

  const alteracoesPendentes =
    JSON.stringify(formulario) !== JSON.stringify(formularioSalvo);
  ...
  function editarProduto(produto: Produto) {
    ...
    const proximoFormulario: Formulario = {
      ...
      videoOficial: produto.videoOficial || "",
    ...
    <main className="min-h-screen bg-slate-100 px-4 py-8 sm:px-6 lg:px-8">
      <div className="mx-auto max-w-7xl">
        ...
        <nav
          ...
          className="sticky top-3 z-10 mb-6 flex gap-2 overflow-x-auto rounded-xl border border-slate-200 bg-white p-2 shadow-sm"
        >
          <a
            href="#produtos-cadastrados"
            className="shrink-0 rounded-lg bg-blue-600 px-4 py-3 text-sm font-semibold text-white transition hover:bg-blue-700 focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-blue-600"
          >
            Buscar produtos
          </a>
          ...
          {[
            ...
            {
              id: "acoes-produto",
              nome: "Revisar e salvar",
            },
          ].map((secao) => (
            <a
              key={secao.id}
              href={`#${secao.id}`}
              className="shrink-0 rounded-lg px-4 py-3 text-sm font-semibold text-slate-600 transition hover:bg-blue-50 hover:text-blue-700 focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-blue-600"
            >
              {secao.nome}
            </a>
          ))}
        ...
        {mensagem && (
          <div
            role="status"
            aria-live="polite"
            className="mb-6 rounded-xl border border-blue-200 bg-white p-4 text-sm font-medium text-slate-700 shadow-sm"
          >
            {mensagem}
          </div>
        )}
        ...
        <section className="mb-10 rounded-2xl border border-slate-200 bg-slate-50 p-4 shadow-sm sm:p-6">
          <div className="mb-6 flex flex-wrap items-center justify-between gap-4 rounded-xl border border-blue-100 bg-blue-50 p-5">
            <div>
              <span className="text-xs font-bold uppercase tracking-wider text-blue-700">
                {editandoId !== null
                  ? `Modo de edição · Produto #${editandoId}`
                  : "Cadastro de produto"}
              </span>
              ...
              <p className="mt-1 text-sm text-slate-500">
                {editandoId !== null
                  ...
                  : "Preencha as seções para publicar um novo produto no Guia Tech."}
              </p>
            </div>
          ...
          {alteracoesPendentes && (
            ...
            >
              Você tem alterações não salvas. Use o botão de
          ...
          >
            ...
            >
              ...
              <section
                ...
                aria-labelledby="secao-01"
              >
                <div className="mb-5 flex items-start gap-3">
                  <span
                    aria-hidden="true"
                    className="flex h-8 w-8 shrink-0 items-center justify-center rounded-lg bg-blue-50 text-sm font-bold text-blue-700"
                  >
                    01
                  </span>
                  ...
                  <div>
                    <h3
                      id="secao-01"
                      className="scroll-mt-28 font-bold text-slate-900"
                    >
                      Identificação
                    </h3>
                ...
                <div className="grid gap-5 md:grid-cols-2">
                  <div>
                    ...
                    <div className="mt-3 rounded-xl border border-blue-100 bg-blue-50 px-4 py-3">
                      ...
                      <p className="mt-1 text-sm leading-6 text-blue-800">
                        Não inclua a cor quando ela for apenas
                        uma variação da mesma oferta. Mantenha
                        informações como armazenamento, memória,
                        tamanho ou configuração quando elas
                        realmente diferenciarem o produto.
                      </p>

                      <p className="mt-2 text-xs leading-5 text-blue-700">
                        Exemplo: use “Apple iPhone 18 Pro Max 1
                        TB” em vez de “Apple iPhone 18 Pro Max 1
                        TB — Prateado”.
                      </p>
                    </div>
                  </div>
                  ...
                  <div>
                    ...
                    <p className="mt-2 text-xs text-slate-500">
                      As mesmas categorias exibidas no site.
                    </p>
                  </div>
                </div>
              </section>
              ...
              >
                <div className="mb-5 flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="mt-1 text-sm leading-6 text-slate-500">
                      Organize a descrição e os detalhes que
                      ajudam o leitor a escolher.
                    </p>
                  </div>
                </div>
                ...
                <div className="grid gap-5 md:grid-cols-2">
                  ...
                  <div className="md:col-span-2">
                    ...
                    <p
                      id="fichaTecnica-ajuda"
                      className="mt-2 text-xs text-slate-500"
                    >
                      Uma especificação por linha, no formato:
                      Tela: 6,7 polegadas.
                    </p>
                  </div>
              ...
              >
                <div className="mb-5 flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="mt-1 text-sm leading-6 text-slate-500">
                      Confira a imagem antes de salvar o cadastro.
                    </p>
                  </div>
                </div>
                ...
                <div className="grid gap-5 md:grid-cols-2">
                  ...
                  <div>
                    ...
                    <div className="relative flex h-56 items-center justify-center rounded-xl border border-dashed border-slate-300 bg-slate-50 p-4">
                      <ImagemProduto
                        key={formulario.imagem.trim()}
              ...
              >
                <div className="mb-5 flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="mt-1 text-sm leading-6 text-slate-500">
                      Informe o preço, o link de compra e,
                      opcionalmente, um vídeo oficial do produto.
                    </p>
                  </div>
                </div>
                ...
                <div className="grid gap-5 md:grid-cols-2">
                  ...
                  <div className="md:col-span-2">
                    ...
                    <p className="mt-2 text-xs leading-5 text-slate-500">
                      Cole o link do vídeo oficial do fabricante
                      no YouTube. Não cole código de incorporação
                      ou iframe.
                    </p>
                  </div>
                </div>
              ...
              <div
                id="acoes-produto"
                className="scroll-mt-28 flex flex-col gap-4 rounded-xl border border-blue-100 bg-blue-50 p-4 sm:flex-row sm:items-center sm:justify-between"
              >
                <p className="text-sm text-slate-600">
                  {editandoId !== null
                    ? "Revise as informações antes de salvar as alterações."
                    : "Tudo pronto? Salve para adicionar o produto ao catálogo."}
                </p>

                <button
                  type="submit"
                  disabled={salvando}
                  className="shrink-0 rounded-xl bg-blue-600 px-6 py-3 font-semibold text-white transition hover:bg-blue-700 focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-blue-600 disabled:cursor-not-allowed disabled:opacity-50"
                >
                  {salvando
                    ? "Salvando..."
                    : editandoId !== null
        ...
        <section>
          <div className="mb-5">
            <h2
              ...
              className="scroll-mt-28 text-2xl font-bold text-slate-900"
            >
            ...
            >
              {carregando
                ? "Carregando catálogo..."
                : `Exibindo ${produtosFiltrados.length} de ${produtos.length} produto(s).`}
            </p>
          </div>

          <div
            role="search"
            aria-label="Filtrar produtos cadastrados"
            className="mb-5 grid gap-4 rounded-2xl border border-slate-200 bg-white p-4 sm:p-5 md:grid-cols-[minmax(0,1fr)_minmax(0,1fr)_auto] md:items-end"
          >
            <div>
              <label
            ...
            <button
              ...
              className="rounded-lg bg-blue-50 px-4 py-3 text-sm font-semibold text-blue-700 transition hover:bg-blue-100 focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-blue-600 disabled:cursor-not-allowed disabled:opacity-50"
            >
              Limpar filtros
            </button>
          </div>
          ...
          {carregando ? (
            ...
            <div className="rounded-xl border border-slate-200 bg-white p-8 text-center shadow-sm">
              ...
              <p className="mt-2 text-sm text-slate-500">
                Tente outro nome ou selecione outra categoria.
              </p>
            </div>
          ) : (
